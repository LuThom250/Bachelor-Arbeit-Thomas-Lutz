...
def plot_result(expr_str, run_name, load_case='constant'): # GEÄNDERT: load_case Parameter
    # Die analytische Lösung hängt vom Lastfall ab
    ...
    if expr_str:
        try:
            ...
            # GEÄNDERT: Charakteristische Durchbiegung zum Zurückskalieren ist vom Lastfall abhängig
            if load_case == 'constant':
                u_c = (q * L**4) / (E * I)
            elif load_case == 'linear':
                u_c = (q * L**5) / (E * I)
    ...
    # Fehlerplot bleibt gleich, da er auf den oben berechneten Werten basiert
...
if __name__ == "__main__":
    ...
    NUM_RUNS = 10 # Anzahl der Wiederholungen pro Experiment
    ...
    EXPERIMENT_CONFIGS = [
        # --- Konstanter Lastfall ---
       # ("Konstante Last, Polynom Ops", ['+', '-', '*'], 'constant'),
        # --- Linearer Lastfall ---
