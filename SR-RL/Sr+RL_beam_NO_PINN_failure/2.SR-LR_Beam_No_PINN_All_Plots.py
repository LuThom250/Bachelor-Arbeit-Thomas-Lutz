...
def plot_result(expr_str, run_name):
    ...
    if expr_str:
        try:
            # Konstanten aus dem String extrahieren und durch ihre numerischen Werte ersetzen
            # Dies ist nicht mehr nötig, da die optimize_constants direkt in der env arbeitet
